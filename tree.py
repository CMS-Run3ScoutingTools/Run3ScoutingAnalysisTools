...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        '/store/data/Run2024C/ScoutingPFRun3/HLTSCOUT/v1/000/379/454/00000/bc1f8e0a-514b-4274-93fb-20265eff8681.root',
 )
)
...
process.scoutingTree = cms.EDAnalyzer('ScoutingTreeMakerRun3',
                                      ...
                                      triggerSelection = cms.vstring(["DST_PFScouting_DoubleMuon_v*"]), 
