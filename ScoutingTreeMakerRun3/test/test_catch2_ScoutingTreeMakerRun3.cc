...
static constexpr auto s_tag = "[ScoutingTreeMakerRun3]";

TEST_CASE("Standard checks of ScoutingTreeMakerRun3", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("ScoutingTreeMakerRun3"
